...
public class LibraryControllerTest {
        ...
        /**
         * Test case to test the end-point for deleting a member using member's email
         * address.
         */
        @Test
        @DirtiesContext
        ...
        /**
         * Test case to test the end-point for getting an existing member using member's
         * id.
         */
        @Test
        @DirtiesContext
        ...
        /**
         * Test case to test the end-point for updating a member's details (name and
         * address).
         */
        @Test
        @DirtiesContext
        void shouldUpdateAnExistingMember() {
                ...
                // Member memberUpdate1 = new Member(null, null, "Johnson S4 Fife Park, KY16
                // 0US", null);
